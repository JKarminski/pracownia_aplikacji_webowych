...
import { useTiles, type Tile } from "../data/tiles";

function flattenSubtopics(tiles: Tile[]) {
...
export default function Categories() {
  ...
  const subs = flattenSubtopics(tiles);

  if (isLoading) {
    return <section className="container"><p>Ładowanie...</p></section>;
  }
